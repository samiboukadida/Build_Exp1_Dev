...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_EOFFILE = 3,                    /* EOFFILE  */
  YYSYMBOL_NUM = 4,                        /* NUM  */
  YYSYMBOL_VAR = 5,                        /* VAR  */
  YYSYMBOL_FNCT = 6,                       /* FNCT  */
  ...
  YYSYMBOL_file_expr = 20,                 /* file_expr  */
...
{
       0,   110,   110,   111,   112,   116,   127,   128,   129,   131,
...
{
  "\"end of file\"", "error", "\"invalid token\"", "EOFFILE", "NUM",
  "VAR", "FNCT", "STRING", "'-'", "'+'", "'*'", "'/'", "NEG", "'='", "'^'",
  "'\\n'", "'('", "')'", "$accept", "input", "file_expr", "line", "exp", YY_NULLPTR
};
...
{
       6,   -14,   -15,   -10,   -12,   -15,    29,   -15,    29,     5,
      -9,   -15,    17,   -15,    29,    29,     9,    30,   -15,   -15,
     -15,    29,    29,    29,    29,    29,   -15,     9,    40,   -15,
      32,    32,     9,     9,     9,   -15
};
...
{
       0,     0,     9,    10,     0,     5,     0,     6,     0,     0,
       0,     3,     0,     8,     0,     0,    17,     0,     1,     4,
       2,     0,     0,     0,     0,     0,     7,    11,     0,    19,
      14,    13,    15,    16,    18,    12
};
...
{
      16,    13,    17,    14,    15,    18,    19,     1,    27,    28,
       2,     3,     4,     5,     6,    30,    31,    32,    33,    34,
      20,     7,     8,    25,     0,    21,    22,    23,    24,     0,
       0,    25,    26,     2,     3,     4,     0,     6,    21,    22,
      23,    24,    23,    24,    25,     8,    25,    29,    21,    22,
      23,    24,     0,     0,    25,     0,     0,    35
};

static const yytype_int8 yycheck[] =
{
       6,    15,     8,    13,    16,     0,    15,     1,    14,    15,
       4,     5,     6,     7,     8,    21,    22,    23,    24,    25,
       3,    15,    16,    14,    -1,     8,     9,    10,    11,    -1,
      -1,    14,    15,     4,     5,     6,    -1,     8,     8,     9,
      10,    11,    10,    11,    14,    16,    14,    17,     8,     9,
      10,    11,    -1,    -1,    14,    -1,    -1,    17
};
...
{
       0,     1,     4,     5,     6,     7,     8,    15,    16,    19,
      20,    21,    22,    15,    13,    16,    22,    22,     0,    15,
       3,     8,     9,    10,    11,    14,    15,    22,    22,    17,
      22,    22,    22,    22,    22,    17
};
...
yyreduce:
  ...
  switch (yyn)
    {
  case 2: /* input: exp EOFFILE  */
#line 110 "exp1.y"
            { cout << (yyvsp[-1].val) << endl; return 0; }
#line 1176 "exp1.tab.c"
    break;

  case 4: /* input: file_expr '\n'  */
#line 112 "exp1.y"
                 { /* Handle the file here */ }
#line 1182 "exp1.tab.c"
    break;

  case 5: /* file_expr: STRING  */
#line 116 "exp1.y"
        {
  /* STRING will contain the path */
  /* Pass this string (file path) to the Mesh loading logic */
  mesh_load((yyvsp[0].str));  // Ensure this function correctly handles absolute paths
}
#line 1192 "exp1.tab.c"
    break;

  case 7: /* line: exp '\n'  */
#line 128 "exp1.y"
           { printf ("\t%.10g\n", (yyvsp[-1].val)); }
#line 1198 "exp1.tab.c"
    break;

  case 8: /* line: error '\n'  */
#line 129 "exp1.y"
             { yyerrok; }
#line 1204 "exp1.tab.c"
    break;

  case 9: /* exp: NUM  */
#line 131 "exp1.y"
              { (yyval.val) = (yyvsp[0].val); }
#line 1210 "exp1.tab.c"
    break;

  case 10: /* exp: VAR  */
#line 132 "exp1.y"
      { (yyval.val) = (yyvsp[0].tptr)->value.var; }
#line 1216 "exp1.tab.c"
    break;

  case 11: /* exp: VAR '=' exp  */
#line 133 "exp1.y"
              { (yyval.val) = (yyvsp[0].val); (yyvsp[-2].tptr)->value.var = (yyvsp[0].val);xy=(yyval.val); cout << (yyvsp[-2].tptr)->name <<"="<<(yyvsp[-2].tptr)->value.var<<endl;}
#line 1222 "exp1.tab.c"
    break;

  case 12: /* exp: FNCT '(' exp ')'  */
#line 134 "exp1.y"
                   { (yyval.val) = (*((yyvsp[-3].tptr)->value.fnctptr))((yyvsp[-1].val)); }
#line 1228 "exp1.tab.c"
    break;

  case 13: /* exp: exp '+' exp  */
#line 135 "exp1.y"
              { (yyval.val) = (yyvsp[-2].val) + (yyvsp[0].val);         }
#line 1234 "exp1.tab.c"
    break;

  case 14: /* exp: exp '-' exp  */
#line 136 "exp1.y"
              { (yyval.val) = (yyvsp[-2].val) - (yyvsp[0].val); }
#line 1240 "exp1.tab.c"
    break;

  case 15: /* exp: exp '*' exp  */
#line 137 "exp1.y"
              { (yyval.val) = (yyvsp[-2].val) * (yyvsp[0].val); }
#line 1246 "exp1.tab.c"
    break;

  case 16: /* exp: exp '/' exp  */
#line 138 "exp1.y"
              { (yyval.val) = (yyvsp[-2].val) / (yyvsp[0].val); }
#line 1252 "exp1.tab.c"
    break;

  case 17: /* exp: '-' exp  */
#line 139 "exp1.y"
                    { (yyval.val) = -(yyvsp[0].val); }
#line 1258 "exp1.tab.c"
    break;

  case 18: /* exp: exp '^' exp  */
#line 140 "exp1.y"
              { (yyval.val) = pow ((yyvsp[-2].val), (yyvsp[0].val)); }
#line 1264 "exp1.tab.c"
    break;

  case 19: /* exp: '(' exp ')'  */
#line 141 "exp1.y"
              { (yyval.val) = (yyvsp[-1].val); }
#line 1270 "exp1.tab.c"
    break;


#line 1274 "exp1.tab.c"
...
void adaptmesh(Mesh & Th,KN<R> un){
  ...
  //_____tab d'aretes sans doublons______
  int nbarete = nt3;
  for (int i=1;i<nt3;i++)
  ...
  }//fini tab d'aretes sans doublons
  ...
  int nbcutedge=k;//nb des arêtes à découpe
